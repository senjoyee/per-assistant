...
const cleanContent = (content: string): string => {
  return content
    ...
    .replace(/###/g, '')   // Remove all ###
    .replace(/^#+\s*/gm, '') // Remove # at the beginning of lines
...
useEffect(() => {
  // Reset chat messages when URL changes
  setChatMessages([]);
...
return (
  <div className="container mx-auto p-4 bg-gray-900 text-gray-100 min-h-screen">
    ...
    <Tabs value={activeTab} onValueChange={(value: string) => setActiveTab(value as 'web' | 'youtube')} className="w-full">
    ...
    {summary && (
      <Card className="bg-gray-800 border-gray-700 rounded-lg overflow-hidden mt-6">
        <CardHeader className="bg-gray-750">
          <CardTitle className="text-cyan-400">Summary of {activeTab === 'web' ? 'Web Page' : 'YouTube Video'}</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
    ...
    {isChatVisible && (
      <Card className="bg-gray-800 border-gray-700 rounded-lg overflow-hidden mt-6">
        <CardHeader className="bg-gray-750">
          <CardTitle className="text-cyan-400">Chat about {activeTab === 'web' ? 'Web Page' : 'YouTube Video'}</CardTitle>
        </CardHeader>
        <CardContent className="pt-6">
